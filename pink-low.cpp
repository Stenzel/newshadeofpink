...
// see pink-low.h for actual code, this contains only static variables and tables

#include "pink-low.h"

int pinklow::instance_cnt = 0;
...
#define F(cf,m,shift)   (0.03125f*cf*(2*((m)>>shift&1)-1))

#define FA(n)   F(1.190566,n,0)+F(0.162580,n,1)+F(0.002208,n,2)+ F(0.025475,n,3)+F(-0.001522,n,4)+F(0.007322,n,5)-PINKLOW_BIAS          
...
const float pinklow::pfira[64] = {FA8(0),FA8(8),FA8(16),FA8(24),FA8(32),FA8(40),FA8(48),FA8(56)}; // 1st FIR lookup table 
const float pinklow::pfirb[64] = {FB8(0),FB8(8),FB8(16),FB8(24),FB8(32),FB8(40),FB8(48),FB8(56)}; // 2nd FIR lookup table   
