...
// see pink-int.h for actual code, this contains only static variables and tables

#include "pink-int.h"

int pinkint::instance_cnt = 0;
...
const int pinkint::pfira[64] = {FA8(0),FA8(8),FA8(16),FA8(24),FA8(32),FA8(40),FA8(48),FA8(56)}; // 1st FIR lookup table 
const int pinkint::pfirb[64] = {FB8(0),FB8(8),FB8(16),FB8(24),FB8(32),FB8(40),FB8(48),FB8(56)}; // 2nd FIR lookup table     
            
// bitreversed lookup table
#define PM16(n) n,0x80,0x40,0x80,0x20,0x80,0x40,0x80,0x10,0x80,0x40,0x80,0x20,0x80,0x40,0x80

const unsigned char pinkint::pnmask[256] = 
{
